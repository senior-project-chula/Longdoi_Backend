...
<script>$(function(){ 
        ...
        <!-- Intro -->
        <section class="site-section site-section-light site-section-top parallax-image" style="background-image: {!!URL::asset('img/business_analysis_iStock_000003923536XSmall.jpg')!!};">
            <div class="container">
                                    ...
                                    <div class="widget">
                                        <div class="widget-advanced widget-advanced-alt">
                                            ...
                                            <div class="widget-header text-center">
                                                <div>
                                            {{-- <img src="img/icon/Custom-Icon-Design-Mini-4-Award-1.ico" alt="avatar" class="widget-image img-circle">
                                            --}}                                            
