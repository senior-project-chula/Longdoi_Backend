...
<!--[if gt IE 9]><!--> <html class="no-js"> <!--<![endif]-->
    <head>
        ...
        <link rel="stylesheet" href="css-backendProUI/bootstrap.min.css">

        <!-- Related styles of various icon packs and plugins -->
        <link rel="stylesheet" href="css-backendProUI/plugins.css">

        <!-- The main stylesheet of this template. All Bootstrap overwrites are defined in here -->
        <link rel="stylesheet" href="css-backendProUI/main.css">

        <!-- Include a specific file here from css/themes/ folder to alter the default theme of the template -->

        <!-- The themes stylesheet of this template (for using specific theme color in individual elements - must included last) -->
        <link rel="stylesheet" href="css-backendProUI/themes.css">
        <!-- END Stylesheets -->

        <!-- Modernizr (browser feature detection library) & Respond.js (enables responsive CSS code on browsers that don't support it, eg IE8) -->
        <script src="js2/vendor/modernizr-respond.min.js"></script>
    </head>
    <body>
        <!-- Page Wrapper -->
                            ...
                            <ul class="sidebar-nav">
                                ...
                                <li class="active">
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            <a href="page_comp_charts.html" class=" active">Charts</a>
                                        </li>
                                        <li>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xs-6">
                                            <div class="pie-chart block-section" data-percent="25" data-line-width="2" data-bar-color="#9d1be1" data-track-color="#ffffff">
                                                <img src="img/placeholders/avatars/avatar16.jpg" alt="avatar" class="pie-avatar img-circle">
                                            </div>
                                        </div>
                                        <div class="col-xs-6">
                                        ...
                                        <div class="col-xs-6">
                                            <div class="pie-chart block-section" data-percent="90" data-line-width="2" data-bar-color="#e17d1b" data-track-color="#ffffff">
                                                <img src="img/placeholders/avatars/avatar15.jpg" alt="avatar" class="pie-avatar img-circle">
                                            </div>
                                        </div>
                                        <div class="col-xs-6">
        ...
        <script src="js2/pages/compCharts.js"></script>
